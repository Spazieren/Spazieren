//
//  NSAttributedString+WMAdditon.m
//
//  Created by will on 16/4/26.
//  Copyright © 2016年 up7042. All rights reserved.
//

#import "NSAttributedString+WMAdditon.h"

@implementation NSAttributedString (WMAdditon)

+ (instancetype)wm_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {

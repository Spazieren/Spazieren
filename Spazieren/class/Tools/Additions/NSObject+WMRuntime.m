...
#import "NSObject+WMRuntime.h"
#import <objc/runtime.h>

@implementation NSObject (WMRuntime)
...
+ (NSArray *)wm_objectsWithArray:(NSArray *)array {
    ...
    // 0. 获得属性数组
    NSArray *list = [self wm_propertiesList];
...
void *propertiesKey = "cn.up7042.propertiesList";
...
void *ivarsKey = "cn.up7042.ivarsList";
